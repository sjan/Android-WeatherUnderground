 ...
 */
public class WundergoundCurrentObservation {
    String image;
    String display;
    String observationLocation;
    String estimated;
    String stationId;
    String observatoinTime;
    String objservationTimeRFC822;
    String observationEpoch;
    String localTime;
    String localTimeEpoch;
    String localTzShort;
    String localTzLong;
    String localTzOffset;
    String weather;
    ...
    public String getObservatoinTime() {
        return observatoinTime;
    }

    public void setObservatoinTime(String observatoinTime) {
        this.observatoinTime = observatoinTime;
    }

    public String getObjservationTimeRFC822() {
        return objservationTimeRFC822;
    }

    public void setObjservationTimeRFC822(String objservationTimeRFC822) {
        this.objservationTimeRFC822 = objservationTimeRFC822;
    }
    ...
    String UV;
    String precip1hrString;
    String precip1hrIn;
    String precip1hrMetric;
    String precipTodayString;
    String precipTodayIn;
    String precipTodayMetric;
    String icon;
    String iconUrl;
    String forecastUrl;
    String historyUrl;
